...
// w is 0 to 100
export default function AuthField({children, w}) {
  ...
  return (
    <div className={`auth-input-field ${isComponentFocused ? "auth-input-field-focus" : ""}`} style={{width: `${w}%`}}>
        <input onFocus={changeFocusOnComponent} onBlur={changeFocusOnComponent} type="text" placeholder={children} onChange={(e) => {}} />
    </div>
  )
}
